...
export function buildWindChart(target, windSpeedData, windDirectionData, sunriseTime=null, sunsetTime=null){
  ...
  const plugins = [sunriseSunsetPlugin, windDirectionPlugin, hourIconsPlugin]; 
  ...
  chartInstances[target] = new Chart(el, {
    ...
    options: {
      ...
      layout: { padding: {top:5,left:5,right:5,bottom:25} },
      onHover: (e, a, chart) => {
