...
document.addEventListener('DOMContentLoaded', () => {
  ...
  try {
    ...
    cards.forEach(card => {
      ...
      // Only prevent mousedown default for actual mouse events, not touch-initiated events
      // This avoids interfering with native touch gestures like pull-to-refresh
      card.addEventListener('mousedown', (ev) => {
        // Skip prevention if this mousedown was generated by a touch event
        // TouchEvent exists and the event has a sourceCapabilities indicating touch
        if (ev.sourceCapabilities && ev.sourceCapabilities.firesTouchEvents) {
          return; // Allow touch-initiated events to proceed normally
        }
        ev.preventDefault(); // Only prevent actual mouse events
      });
